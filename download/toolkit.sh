...
echo "[INSTALL] Successfully added alias to your available shell configuration files. If you don't use bash or zsh, you can add it manually to your shell configuration file"
