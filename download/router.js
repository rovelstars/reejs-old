let path = await import("/dist/libs/pathToRegexp.js");
import { html, render, Component } from "/dist/libs/ree.react.js";
...
export async function renderJsx(url, data = undefined, loader = false) {
  ...
  try {
    ...
    let url = routes.find((u) => u.url == "/500").jsx || "/src/pages/crash.js";
...
export async function load(url = "/", scrolling = true, popped = false, wasInit=false) {
  ...
  if (!route) {
    ...
    await renderJsx("/src/pages/notfound.js", data);
    if (scrolling) {
